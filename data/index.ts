...
// 4. 在下方引用路径: "/images/cases/my-new-case.webp"
// ==========================================
...
const CONFIG_IMAGES = {
  cases: {
    ...
    // xiangjiang_main: "/images/cases/xiangjiang-main.webp",
  ...
  news: {
    // [示例] 本地图片:
    // news1: "/images/news/award-2024.webp",
  ...
  zh: [
    {
      ...
      image: "/images/cases/xiangjiang-one/cover.webp",
      ...
      gallery: Array.from({ length: 24 }, (_, i) => `/images/cases/gallery/xiangjiang-one/xiangjiang-one-${String(i + 1).padStart(2, '0')}.webp`)
    },
    {
      id: "c2",
      ...
      category: "工装",
      type: "idealyou", // 享你所想-空间案例
      image: "/images/cases/neptune-mumbai-2025-cover.webp",
      description: "位于印度孟买的NEPTUNE品牌展厅，集成灯光与空气系统的现代商业空间，以沉浸式体验诠释品牌未来感。",
      gallery: Array.from({ length: 21 }, (_, i) => `/images/cases/gallery/neptune-mumbai-2025-${String(i + 1).padStart(2, '0')}.webp`)
    },
    {
      id: "jiangshan-one",
      title: "江山一号",
      category: "平层",
      type: "idealyou", // 享你所想-空间案例
      image: "/images/cases/jiangshan-one/cover.webp",
      ...
      gallery: Array.from({ length: 7 }, (_, i) => `/images/cases/gallery/jiangshan-one/jiangshan-one-${String(i + 1).padStart(2, '0')}.webp`)
    },
    {
      ...
      category: "别墅洋房",
      type: "idealyou", // 享你所想-空间案例
      image: "/images/cases/bgy-shuilantian-9/cover.webp",
      description: "位于岳麓核心区的湖景大宅，以现代东方的线条与材质诠释宁静、轻奢的生活质感。",
      gallery: Array.from({ length: 7 }, (_, i) => `/images/cases/gallery/bgy-shuilantian-9/bgy-shuilantian-9-${String(i + 1).padStart(2, '0')}.webp`)
    },
    {
      ...
      category: "平层",
      type: "idealyou", // 享你所想-空间案例
      image: "/images/cases/beichen-hanjiangfu/cover.webp",
      description: "位于长沙核心地段的现代精品住宅，以简约线条与高级材质诠释都市生活美学，打造低调而精致的居住体验。",
      gallery: Array.from({ length: 4 }, (_, i) => `/images/cases/gallery/beichen-hanjiangfu/beichen-hanjiangfu-${String(i + 1).padStart(2, '0')}.webp`)
    },
    {
      id: "bgy-lanbaowan-29",
      title: "碧桂园蓝宝湾29号",
      category: "别墅洋房",
      type: "idealyou", // 享你所想-空间案例
      image: "/images/cases/bgy-lanbaowan-29/cover.webp",
      description: "位于优质地段的别墅项目，以现代设计语言诠释高端居住体验。",
      gallery: Array.from({ length: 18 }, (_, i) => `/images/cases/bgy-lanbaowan-29/bgy-lanbaowan-29-${String(i + 1).padStart(2, '0')}.webp`)
    },
    {
      id: "jindi-sanqianfu",
      title: "金地三千府",
      category: "别墅洋房",
      type: "idealyou", // 享你所想-空间案例
      image: "/images/cases/jindi-sanqianfu/cover.webp",
      description: "高端别墅项目，融合现代设计与自然景观，打造理想居住空间。",
      gallery: Array.from({ length: 13 }, (_, i) => `/images/cases/jindi-sanqianfu/jindi-sanqianfu-${String(i + 1).padStart(2, '0')}.webp`)
    },
    {
      ...
      category: "工装",
      type: "idealyou", // 享你所想-空间案例
      image: "/images/cases/jiabaoli-art-gallery/cover.webp",
      description: "艺术涂料品牌展厅，以现代设计语言展示产品特性，营造专业而富有艺术感的展示空间。",
      gallery: [
        ...Array.from({ length: 18 }, (_, i) => `/images/cases/jiabaoli-art-gallery/jiabaoli-art-gallery-${String(i + 1).padStart(2, '0')}.webp`),
        ...Array.from({ length: 3 }, (_, i) => `/images/cases/jiabaoli-art-gallery/jiabaoli-art-gallery-${String(i + 20).padStart(2, '0')}.webp`)
      ]
    },
    {
      ...
      category: "工装",
      type: "idealyou", // 享你所想-空间案例
      image: "/images/cases/kabaili-art-paint/cover.webp",
      description: "艺术涂料品牌展示空间，通过创新的空间设计展现产品的多样性和艺术价值。",
      gallery: Array.from({ length: 12 }, (_, i) => `/images/cases/kabaili-art-paint/kabaili-art-paint-${String(i + 1).padStart(2, '0')}.webp`)
    },
    {
      ...
      category: "工装",
      type: "idealyou", // 享你所想-空间案例
      image: "/images/cases/xichangjie-wedding/cover.webp",
      description: "专业婚纱摄影工作室，打造浪漫而精致的拍摄空间，为新人提供完美的拍摄体验。",
      gallery: Array.from({ length: 20 }, (_, i) => `/images/cases/xichangjie-wedding/xichangjie-wedding-${String(i + 1).padStart(2, '0')}.webp`)
    },
    {
      ...
      category: "精装",
      type: "idealyou", // 享你所想-空间案例
      image: "/images/cases/vanke-golden-home-1/cover.webp",
      description: "万科金色家园精装项目，以现代简约风格打造舒适宜居的居住空间。",
      gallery: Array.from({ length: 4 }, (_, i) => `/images/cases/vanke-golden-home-1/vanke-golden-home-1-${String(i + 1).padStart(2, '0')}.webp`)
    },
    {
      ...
      category: "精装",
      type: "idealyou", // 享你所想-空间案例
      image: "/images/cases/vanke-golden-home-2/cover.webp",
      description: "万科金色家园精装项目，注重细节与品质，营造温馨雅致的居住环境。",
      gallery: Array.from({ length: 4 }, (_, i) => `/images/cases/vanke-golden-home-2/vanke-golden-home-2-${String(i + 1).padStart(2, '0')}.webp`)
    },
    {
      id: "dongfang-ying",
      title: "东方映",
      category: "平层",
      type: "idealyou", // 享你所想-空间案例
      image: "/images/cases/dongfang-ying/cover.webp",
      description: "现代平层住宅项目，以简约设计理念打造舒适宜居的居住空间。",
      gallery: Array.from({ length: 12 }, (_, i) => `/images/cases/dongfang-ying/dongfang-ying-${String(i + 1).padStart(2, '0')}.webp`)
    },
    {
      id: "fengqi-luming",
      title: "凤起鹿鸣",
      category: "平层",
      type: "idealyou", // 享你所想-空间案例
      image: "/images/cases/fengqi-luming/cover.webp",
      description: "高端平层住宅项目，融合现代设计与东方美学，营造优雅精致的居住体验。",
      gallery: Array.from({ length: 12 }, (_, i) => `/images/cases/fengqi-luming/fengqi-luming-${String(i + 1).padStart(2, '0')}.webp`)
    },
    {
...
const productsData = [
  // --- Soft Furnishings (Furniture) ---
  {
    ...
    image: "/images/products/banana-boat-sofa/cover.webp",
    ...
    gallery: [
      "/images/products/banana-boat-sofa/cover.webp",
      "/images/products/banana-boat-sofa/banana-boat-sofa-01.webp"
    ]
  },
  {
    id: "lc-mama",
    category: "Soft Furnishings",
    image: "/images/products/mama-hug-chair/cover.webp",
    ...
    gallery: [
      "/images/products/mama-hug-chair/cover.webp",
      "/images/products/mama-hug-chair/mama-hug-chair-01.webp"
    ]
  },
  {
    id: "sf-052-1",
    category: "Soft Furnishings",
    image: "/images/products/sf052-1/cover.webp",
    ...
    gallery: [
      "/images/products/sf052-1/cover.webp",
      "/images/products/sf052-1/sf052-1-01.webp"
    ]
  },
  {
    id: "lc-040",
    category: "Soft Furnishings",
    image: "/images/products/lc040-sofa/cover.webp",
    ...
    gallery: [
      "/images/products/lc040-sofa/cover.webp",
      "/images/products/lc040-sofa/lc040-sofa-01.webp"
    ]
  },
  {
    id: "sf-115-2",
    category: "Soft Furnishings",
    image: "/images/products/sf115-2-sofa/cover.webp",
    ...
    gallery: [
      "/images/products/sf115-2-sofa/cover.webp",
      "/images/products/sf115-2-sofa/sf115-2-sofa-01.webp"
    ]
  },
  {
    id: "lc-036",
    category: "Soft Furnishings",
    image: "/images/products/lc036-armchair/cover.webp",
    ...
    gallery: [
      "/images/products/lc036-armchair/cover.webp",
      "/images/products/lc036-armchair/lc036-armchair-01.webp"
    ]
  },
  {
    id: "lc-105",
    category: "Soft Furnishings",
    image: "/images/products/lc105-armchair/cover.webp",
    ...
    gallery: [
      "/images/products/lc105-armchair/cover.webp",
      "/images/products/lc105-armchair/lc105-armchair-01.webp"
    ]
  },
  {
    id: "cb2515-chanel-sofa",
    category: "Soft Furnishings",
    image: "/images/products/cb2515-chanel-sofa/cover.webp",
    ...
    gallery: [
      "/images/products/cb2515-chanel-sofa/cover.webp",
      "/images/products/cb2515-chanel-sofa/cb2515-chanel-sofa-01.webp"
    ]
  },
  {
    id: "sf127-terrace-sofa",
    category: "Soft Furnishings",
    image: "/images/products/sf127-terrace-sofa/cover.webp",
    ...
    gallery: [
      "/images/products/sf127-terrace-sofa/cover.webp",
      "/images/products/sf127-terrace-sofa/sf127-terrace-sofa-01.webp"
    ]
  },
  {
    id: "fc014-armchair",
    category: "Soft Furnishings",
    image: "/images/products/fc014-armchair/cover.webp",
    ...
    gallery: [
      "/images/products/fc014-armchair/cover.webp",
      "/images/products/fc014-armchair/fc014-armchair-01.webp"
    ]
  },
  {
    id: "lc046-chaise",
    category: "Soft Furnishings",
    image: "/images/products/lc046-chaise/cover.webp",
    ...
    gallery: [
      "/images/products/lc046-chaise/cover.webp",
      "/images/products/lc046-chaise/lc046-chaise-01.webp"
    ]
  },
  {
    id: "lc151-spanish-chair",
    category: "Soft Furnishings",
    image: "/images/products/lc151-spanish-chair/cover.webp",
    ...
    gallery: [
      "/images/products/lc151-spanish-chair/cover.webp",
      "/images/products/lc151-spanish-chair/lc151-spanish-chair.webp"
    ]
  },
  {
    id: "hunting-chair",
    category: "Soft Furnishings",
    image: "/images/products/hunting-chair/cover.webp",
    ...
    gallery: [
      "/images/products/hunting-chair/cover.webp",
      "/images/products/hunting-chair/hunting-chair-01.webp"
    ]
  },
  {
    id: "chief-chair",
    category: "Soft Furnishings",
    image: "/images/products/chief-chair/cover.webp",
    ...
    gallery: [
      "/images/products/chief-chair/cover.webp",
      "/images/products/chief-chair/chief-chair-01.webp"
    ]
  },
  {
    id: "chenxi-chair",
    category: "Soft Furnishings",
    image: "/images/products/chenxi-chair/cover.webp",
    ...
    gallery: [
      "/images/products/chenxi-chair/cover.webp",
      "/images/products/chenxi-chair/chenxi-chair-01.webp"
    ]
  },
  {
    id: "leisure-chair-936",
    category: "Soft Furnishings",
    image: "/images/products/leisure-chair-936/cover.webp",
    ...
    gallery: [
      "/images/products/leisure-chair-936/cover.webp",
      "/images/products/leisure-chair-936/leisure-chair-936-01.webp"
    ]
  },
  {
    id: "cb2382-leisure-chair",
    category: "Soft Furnishings",
    image: "/images/products/cb2382-leisure-chair/cover.webp",
    ...
    gallery: [
      "/images/products/cb2382-leisure-chair/cover.webp",
      "/images/products/cb2382-leisure-chair/cb2382-leisure-chair-01.webp"
    ]
  },
  {
    id: "coffee-table-18010",
    category: "Soft Furnishings",
    image: "/images/products/coffee-table-18010/cover.webp",
    ...
    gallery: [
      "/images/products/coffee-table-18010/cover.webp",
      "/images/products/coffee-table-18010/coffee-table-18010-01.webp"
    ]
  },
  {
    id: "coffee-table-2301",
    category: "Soft Furnishings",
    image: "/images/products/coffee-table-2301/cover.webp",
    ...
    gallery: [
      "/images/products/coffee-table-2301/cover.webp",
      "/images/products/coffee-table-2301/coffee-table-2301-01.webp"
    ]
  },
  {
    id: "coffee-table-2309",
    category: "Soft Furnishings",
    image: "/images/products/coffee-table-2309/cover.webp",
    ...
    gallery: [
      "/images/products/coffee-table-2309/cover.webp",
      "/images/products/coffee-table-2309/coffee-table-2309-01.webp"
    ]
  },
  ...
  // --- Artistic Coatings (艺术涂料) ---
  {
    ...
    image: "/images/products/modern-sand-velvet/cover.webp",
    ...
    gallery: [
      "/images/products/modern-sand-velvet/cover.webp",
      "/images/products/modern-sand-velvet/modern-sand-velvet-01.webp"
    ]
  },
  {
    id: "skin-feel-lambskin",
    category: "Artistic Coatings",
    image: "/images/products/skin-feel-lambskin/cover.webp",
    ...
    gallery: [
      "/images/products/skin-feel-lambskin/cover.webp",
      "/images/products/skin-feel-lambskin/skin-feel-lambskin-01.webp"
    ]
  },
  {
    id: "fass-sand-velvet",
    category: "Artistic Coatings",
    image: "/images/products/fass-sand-velvet/cover.webp",
    ...
    gallery: [
      "/images/products/fass-sand-velvet/cover.webp",
      "/images/products/fass-sand-velvet/fass-sand-velvet-01.webp"
    ]
  },
  {
    id: "metal-relief",
    category: "Artistic Coatings",
    image: "/images/products/metal-relief/cover.webp",
    ...
    gallery: [
      "/images/products/metal-relief/cover.webp",
      "/images/products/metal-relief/metal-relief-01.webp"
    ]
  },
  {
    id: "metallic-velvet",
    category: "Artistic Coatings",
    image: "/images/products/metallic-velvet/cover.webp",
    ...
    gallery: [
      "/images/products/metallic-velvet/cover.webp",
      "/images/products/metallic-velvet/metallic-velvet-01.webp"
    ]
  },
  {
    id: "turin-sand-velvet",
    category: "Artistic Coatings",
    image: "/images/products/turin-sand-velvet/cover.webp",
    ...
    gallery: [
      "/images/products/turin-sand-velvet/cover.webp",
      "/images/products/turin-sand-velvet/turin-sand-velvet-01.webp"
    ]
  },
  {
    id: "milan-velvet",
    category: "Artistic Coatings",
    image: "/images/products/milan-velvet/cover.webp",
    ...
    gallery: [
      "/images/products/milan-velvet/cover.webp",
      "/images/products/milan-velvet/milan-velvet-01.webp"
    ]
  },
  {
    id: "ruida-yaron",
    category: "Artistic Coatings",
    image: "/images/products/ruida-yaron/cover.webp",
    ...
    gallery: [
      "/images/products/ruida-yaron/cover.webp",
      "/images/products/ruida-yaron/ruida-yaron-01.webp"
    ]
  },
  {
    id: "vitas",
    category: "Artistic Coatings",
    image: "/images/products/vitas/cover.webp",
    ...
    gallery: [
      "/images/products/vitas/cover.webp",
      "/images/products/vitas/vitas-01.webp"
    ]
  },
  {
    id: "micro-cement",
    category: "Artistic Coatings",
    image: "/images/products/micro-cement/cover.webp",
    ...
    gallery: [
      "/images/products/micro-cement/cover.webp",
      "/images/products/micro-cement/micro-cement-01.webp"
    ]
  },
  {
    id: "massey-plaster",
    category: "Artistic Coatings",
    image: "/images/products/massey-plaster/cover.webp",
    ...
    gallery: [
      "/images/products/massey-plaster/cover.webp",
      "/images/products/massey-plaster/massey-plaster-01.webp"
    ]
  },
  {
    id: "sicilian-plaster",
    category: "Artistic Coatings",
    image: "/images/products/sicilian-plaster/cover.webp",
    ...
    gallery: [
      "/images/products/sicilian-plaster/cover.webp",
      "/images/products/sicilian-plaster/sicilian-plaster-01.webp"
    ]
  },
  {
    id: "purdue-plaster",
    category: "Artistic Coatings",
    image: "/images/products/purdue-plaster/cover.webp",
    ...
    gallery: [
      "/images/products/purdue-plaster/cover.webp",
      "/images/products/purdue-plaster/purdue-plaster-01.webp"
    ]
  },
  {
    id: "raphael-retro",
    category: "Artistic Coatings",
    image: "/images/products/raphael-retro/cover.webp",
    ...
    gallery: [
      "/images/products/raphael-retro/cover.webp",
      "/images/products/raphael-retro/raphael-retro-01.webp"
    ]
  },
  {
    id: "marmorino",
    category: "Artistic Coatings",
    image: "/images/products/marmorino/cover.webp",
    ...
    gallery: [
      "/images/products/marmorino/cover.webp",
      "/images/products/marmorino/marmorino-01.webp"
    ]
  },
  {
    id: "ea-metallic",
    category: "Artistic Coatings",
    image: "/images/products/ea-metallic/cover.webp",
    ...
    gallery: [
      "/images/products/ea-metallic/cover.webp",
      "/images/products/ea-metallic/ea-metallic-01.webp"
    ]
  },
  {
    id: "travertine",
    category: "Artistic Coatings",
    image: "/images/products/travertine/cover.webp",
    ...
    gallery: [
      "/images/products/travertine/cover.webp",
      "/images/products/travertine/travertine-01.webp"
    ]
  },
  {
    id: "shihuanu",
    category: "Artistic Coatings",
    image: "/images/products/shihuanu/cover.webp",
    ...
    gallery: [
      "/images/products/shihuanu/cover.webp",
      "/images/products/shihuanu/shihuanu-01.webp"
    ]
  },
  {
    id: "mica-colored-stone",
    category: "Artistic Coatings",
    image: "/images/products/mica-colored-stone/cover.webp",
    ...
    gallery: [
      "/images/products/mica-colored-stone/cover.webp",
      "/images/products/mica-colored-stone/mica-colored-stone-01.webp"
    ]
  },
  {
    id: "maya-stone",
    category: "Artistic Coatings",
    image: "/images/products/maya-stone/cover.webp",
    ...
    gallery: [
      "/images/products/maya-stone/cover.webp",
      "/images/products/maya-stone/maya-stone-01.webp"
    ]
  },
...
export const designersData: Record<'zh' | 'en', Designer[]> = {
  zh: [
    { 
      ...
      image: "/images/designers/tang-guishu.webp",
      sections: [
        {
          title: "设计理念",
          variant: "paragraph",
    ...
    },
    {
      ...
      image: "/images/designers/peng-yi.webp",
      sections: [
        {
          title: "设计理念",
          variant: "paragraph",
    ...
    },
    {
      ...
      image: "/images/designers/kuang-yingzhi.webp",
      sections: [
        {
          title: "个人荣誉",
          items: [
