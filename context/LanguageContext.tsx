...
export const translations = {
  zh: {
    ...
    'about.mission.desc': 'NEXT+ 品牌是一个集合型品牌。致力于突破大环境现状，打造一个针对当下有着独特商业品质情怀追求的视觉美学、策略计划、商业定位、空间设计、咨询管理的品牌公司。',
    ...
    'nexthome.service.design': '空间设计规划',
    'nexthome.service.design.desc': '空间规划、动线设计、灯光设计、软装陈列、艺术装置与全屋定制一体化方案。',
    'nexthome.service.construct': '施工技术管理',
    'nexthome.service.construct.desc': '短平快、高质量、高效率的扁平化管理施工，严格品控体系与精细化工艺标准。',
    ...
    'spacemagic.rd.mat.desc': '主材品牌、辅材品牌',
    ...
    'idealyou.filter.villa': '别墅洋房',
    'idealyou.filter.flat': '平层',
    'idealyou.filter.refined': '精装',
    'idealyou.filter.commercial': '工装',
    ...
    'mealtime.intro.desc': 'NEXT+ MEALTIME 食间坚信，餐厅不仅是享用美食的地方，更是人与人交流、分享美好时刻的场所。',
    ...
    'contact.address.1': '长沙市芙蓉区韭菜园路058号（NEXT+MEALTIME）',
    'contact.address.2': '湖南省长沙市开福区五矿live33栋3层（NEXT+HOME）',
  ...
  en: {
    ...
    'nexthome.service.design': 'Spatial Design & Planning',
    'nexthome.service.design.desc': 'Integrated solutions for spatial planning, circulation design, lighting, soft furnishing, art installations, and whole-house customization.',
    'nexthome.service.construct': 'Construction & Technical Management',
    'nexthome.service.construct.desc': 'Fast-paced, high-quality, high-efficiency flat management with strict quality control and refined craftsmanship standards.',
    'nexthome.sm.title': 'Space Magic',
    ...
    'spacemagic.rd.mat.desc': 'Main Material Brands, Auxiliary Material Brands',
    ...
    'idealyou.filter.villa': 'Villa',
    'idealyou.filter.flat': 'Flat',
    'idealyou.filter.refined': 'Refined',
    ...
    'mealtime.intro.title': 'Collection Discover',
    'mealtime.intro.desc': 'NEXT+ MEALTIME believes that a restaurant is not just a place to enjoy food, but a place for people to communicate and share beautiful moments.',
    'mealtime.coffee.title': 'NEXT+ COFFEE',
    ...
    'contact.address.1': 'No. 058 Jiucaiyuan Road, Furong District, Changsha (NEXT+MEALTIME)',
    'contact.address.2': 'Floor 3, Building 33, Wukuang Live, Kaifu District, Changsha, Hunan (NEXT+HOME)',
    'contact.phone.value': '0731-82244254',
    ...
    'join.contact.name': 'Customer Service',
    'join.contact.phone': 'Tel',
    'join.contact.phone.val': '186-7373-1199',
    'join.contact.address': 'Add',
    'join.contact.address.val': 'No. 058, Jiucaiyuan Road, Furong District, Changsha (NEXT+MEALTIME)',
